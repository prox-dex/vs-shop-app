...
<template>
  <div class="flex flex-1">
    ...
    <div class="flex-1 flex flex-col">
      <div class="h-(--ui-header-height) shrink-0 flex items-center px-4 border-b border-zinc-200 dark:border-zinc-800 sticky top-0 z-20 bg-(--ui-bg)/80 backdrop-blur-md">
        <UButton
